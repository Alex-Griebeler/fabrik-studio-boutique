// Regra de vencimento da Fabrik — ESPELHO para o frontend.
//
// A fonte canônica vive em supabase/functions/_shared/finance/dueDateRule.ts
// (as edge functions precisam de imports com extensão .ts, que o bundle
// do Vite não aceita — por isso o espelho). A PARIDADE entre os dois é
// GARANTIDA POR TESTE: supabase/functions/_shared/finance/
// dueDateRule.parity.test.ts compara as duas implementações sobre uma
// matriz de casos e quebra o CI se divergirem. Alterou um, altere o
// outro.
//
